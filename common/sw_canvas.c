                             ...
                             int width, int height)
{
    ...
    data = SPICE_REALIGN_CAST(uint32_t *,(uint8_t *)pixman_image_get_data(dest) + y * stride + 4 * x);
                             ...
                             const QRegion *clip)
{
    ...
    src = pixman_image_create_bits(PIXMAN_x8r8g8b8,
                                   src_width,
                                   src_height,
                                   SPICE_REALIGN_CAST(uint32_t*,src_data),
                                   src_stride);
                           ...
                           )
{
    ...
    image = pixman_image_create_bits(spice_surface_format_to_pixman (format),
                                     width, height, SPICE_REALIGN_CAST(uint32_t *,data), stride);
